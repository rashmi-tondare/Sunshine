...
import com.experiments.sunshine.app.BuildConfig;
import com.experiments.sunshine.app.MainActivity;
import com.experiments.sunshine.app.R;
import com.experiments.sunshine.app.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        String units = sharedPreferences.getString(getContext().getString(R.string.pref_units_key), getContext().getString(R.string.pref_units_value_metric));
        ...
        try {
            ...
            if (inputStream == null) {
                // Nothing to do.
                Log.i(LOG_TAG, "No response received");
                return;
            }
...
//                JSONObject temperatureObject = dayForecast.getJSONObject(OWM_TEMPERATURE);
     ...
     */
        ...
        // Otherwise, insert it using the content resolver and the base URI
            ...
            Uri insertedLocationUri = contentResolver.insert(uri, contentValues);
    ...
    public static Account getSyncAccount(Context context) {
        Log.i(LOG_TAG, "get sync account");
    ...
    public static void initializeSyncAdapter(Context context) {
        Log.i(LOG_TAG, "initialize sync adapter");
