...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            case WEATHER:
                noOfRowsDeleted = db.delete(WeatherContract.WeatherEntry.TABLE_NAME,
                        selection,
                        selectionArgs);
                break;
            case LOCATION:
                noOfRowsDeleted = db.delete(WeatherContract.LocationEntry.TABLE_NAME,
                        selection,
                        selectionArgs);
                break;
            default:
    ...
    public int update(
        ...
        switch (sUriMatcher.match(uri)) {
            case WEATHER:
                noOfRowsUpdated = db.update(WeatherContract.WeatherEntry.TABLE_NAME,
                        values,
                        selection,
                        selectionArgs);
                break;
            case LOCATION:
                noOfRowsUpdated = db.update(WeatherContract.LocationEntry.TABLE_NAME,
                        values,
                        selection,
                        selectionArgs);
                break;
